  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-9 h-9 flex items-center justify-center border border-[#e8ded3] text-[#4a4a4a] hover:border-[#111111] hover:text-[#111111] disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
      >
      ...
      {pages.map((p, i) =>
        p === "…" ? (
          <span key={`ellipsis-${i}`} className="w-9 h-9 flex items-center justify-center text-[#b8b0a8] text-sm">
            …
          </span>
        ) : (
          <button

          ...
          <form action={formAction} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/auth/forgot-password" className="text-[10px] tracking-wide text-[#C8A96B] hover:text-[#C8A96B]/70 transition-colors">
                  Forgot password?
                </Link>
              </div>
            ...
            <p className="text-center text-[11px] tracking-wide text-white/50 lg:text-[#111111]/40 pt-1">
              ...
              <Link href="/auth/register" className="text-[#C8A96B] hover:text-[#C8A96B]/70 transition-colors">
                Create an account
              </Link>
            </p>

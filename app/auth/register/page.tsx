      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-[#F8F5F2] px-8 sm:px-12 lg:px-16 py-16 relative">
        ...
        <div className="relative z-10 w-full max-w-sm lg:bg-transparent lg:shadow-none lg:border-none lg:p-0 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 lg:rounded-none shadow-2xl lg:shadow-none">
          ...
          <form action={formAction} className="space-y-5">
            ...
            {/* Full Name */}
            <div>
              <label htmlFor="name" className="block text-[10px] tracking-[0.18em] uppercase text-white/60 lg:text-[#111111]/50 mb-2">
                Full Name
              </label>
              <input
            ...
            {/* Password */}
            <div>
              <label htmlFor="password" className="block text-[10px] tracking-[0.18em] uppercase text-white/60 lg:text-[#111111]/50 mb-2">
                Password
              </label>
              ...
              <p id="password-hint" className="mt-1.5 text-[10px] text-white/40 lg:text-[#111111]/35">
                At least 8 characters with letters and numbers.
              </p>
              {state.errors?.password && (
                <p id="password-error" className="mt-1 text-xs text-red-400 lg:text-red-600">{state.errors.password[0]}</p>
              )}
            </div>
